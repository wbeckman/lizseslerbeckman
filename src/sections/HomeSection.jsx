...
const HomeSection = () => (
  <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-10 my-auto">
    ...
    <div className="w-full md:w-1/2">
      <img
        src="./header.jpg"
        alt="Liz Sesler-Beckman, pianist in Erie, PA"
    ...
    <div className="w-full md:w-1/2 text-left">
      ...
      <p className="my-2 leading-relaxed font-[Instrument_Sans]">
        I am an experienced jazz and classical pianist and accompanist based in
        Erie, PA, also serving the Buffalo, NY area. Whether you’re looking for
        music to elevate a special occasion or lessons to grow your skills, I’m
        here to help.
      </p>
      <p className="my-2 leading-relaxed font-[Instrument_Sans]">
