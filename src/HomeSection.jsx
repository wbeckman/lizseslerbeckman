...
const HomeSection = () => (
  <div className="flex flex-col md:flex-row items-center justify-between gap-8">
    ...
    <div className="w-full md:w-1/2 text-left">
      ...
      <h2 className="text-xl font-semibold my-3 font-[Gloock]">
      ...
      <p className="my-2 leading-relaxed font-[Instrument_Sans]">
      If you are interested in hiring me to play for your event or to inquire about  lessons, please contact: <a className='text-blue-500' href="mailto:lizseslerbeckman@gmail.com">lizseslerbeckman@gmail.com</a>
      </p>
    </div>
  </div>
);
